...
function Enemies(_hero) 
{
    ...
    this.circle = new Circle(this.hero.Transform.RelativePosition.x, this.hero.Transform.RelativePosition.y, 350);
    this.randCircle = Math.Random.InCircle(this.circle);
    ...
    this.SetImageSource = function(_source)
    {
        this.Renderer.Material.Source = _source;
    }
    
    this.WalkToHero = function()
    {
        this.direction = this.hero.Transform.RelativePosition.x
    }
