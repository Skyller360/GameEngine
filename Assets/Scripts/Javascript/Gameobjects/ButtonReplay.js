...
function ButtonReplay() 
{
	...
	this.Transform.RelativePosition = new Vector(canvas.width / 2 - this.Transform.Size.x / 2, canvas.height - 200 - this.Transform.Size.y / 2);
	...
	{
		ctx.fillStyle = "rgba(154,72,128,0.4)";
		ctx.fillRect(this.Transform.RelativePosition.x - this.Transform.Size.x * this.Transform.Scale.x * this.Transform.Pivot.x,
						this.Transform.RelativePosition.y - this.Transform.Size.y * this.Transform.Scale.y * this.Transform.Pivot.x,
		...
		ctx.fillText(this.name, this.Transform.RelativePosition.x + this.Transform.Size.x / 2, this.Transform.RelativePosition.y + this.Transform.Size.y / 2);
		this.PostUpdate();
	};
	/**
	 * @function PostUpdate
	...
	this.onClicked = function() 
	{
		...
		this.Physics.countHovered ++;
		console.log("CLICK");
		Application.LoadedScene = /*Scenes["GridLevel"]*/new GridLevel();
	}
	/**
